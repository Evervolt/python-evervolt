...
class DevicesApi:
    ...
    def devices_delete(
        ...
        :param devices_delete_request:
        :type devices_delete_request: DevicesDeleteRequest
        ...
        _param = self._devices_delete_serialize(
            devices_delete_request=devices_delete_request,
    ...
    def _devices_delete_serialize(
        ...
        if devices_delete_request is not None:
            _body_params = devices_delete_request
    ...
    def devices_post(
        ...
        :param devices_post_request:
        :type devices_post_request: DevicesPostRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._devices_post_serialize(
            devices_post_request=devices_post_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _devices_post_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if devices_post_request is not None:
            _body_params = devices_post_request
