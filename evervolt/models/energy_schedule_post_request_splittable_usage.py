...
class EnergySchedulePostRequestSplittableUsage(BaseModel):
    """
    EnergySchedulePostRequestSplittableUsage
    """ # noqa: E501
    duration: Optional[StrictStr] = None
    usage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Usage in kW for the given duration")
    __properties: ClassVar[List[str]] = ["duration", "usage"]
